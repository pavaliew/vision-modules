...
static const _SetLoggerLevelsResult_type_support_symbol_names_t _SetLoggerLevelsResult_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, rcl_interfaces, msg, SetLoggerLevelsResult)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, rcl_interfaces, msg, SetLoggerLevelsResult)),
  }
};
...
{
  return &::rcl_interfaces::msg::rosidl_typesupport_cpp::SetLoggerLevelsResult_message_type_support_handle;
}
