  ...
  // Field name: levels
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rcl_interfaces, msg, LoggerLevel
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _SetLoggerLevels_Request__ros_msg_type * ros_message = static_cast<_SetLoggerLevels_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: levels
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: results
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, rcl_interfaces, msg, SetLoggerLevelsResult
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _SetLoggerLevels_Response__ros_msg_type * ros_message = static_cast<_SetLoggerLevels_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: results
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
