  ...
  void * untyped_ros_message)
{
  ...
  _GetLoggerLevels_Request__ros_msg_type * ros_message = static_cast<_GetLoggerLevels_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: names
  {
    uint32_t cdrSize;
    cdr >> cdrSize;
  ...
  void * untyped_ros_message)
{
  ...
  _GetLoggerLevels_Response__ros_msg_type * ros_message = static_cast<_GetLoggerLevels_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: levels
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
